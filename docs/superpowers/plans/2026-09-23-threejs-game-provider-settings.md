...
- [ ] **Step 1: Add failing tests for URL/model validation and fallback**
...
- [ ] **Step 3: Implement config validation, safe GET config, and run capture**
...
- [ ] **Step 4: Test per-run isolation, legacy fallback, and key non-disclosure**
...
- [ ] **Step 6: Commit the server/API task**
...
- [ ] **Step 1: Add failing browser-adapter tests for provider payload and dialog cancellation**
...
- [ ] **Step 3: Replace wide grid with a 600×800 fixed-design panel**
...
- [ ] **Step 4: Add settings dialog and per-run browser configuration**
...
- [ ] **Step 5: Re-run UI/controller tests and check secret boundaries**
...
- [ ] **Step 6: Commit the panel/settings UI task**
...
- [ ] **Step 1: Add renderer contract tests that protect deterministic core behavior**
...
- [ ] **Step 2: Run renderer/core tests and confirm the renderer contract is missing**

Run: `node --test demo/test_space_shooter_logic.cjs`
Expected: renderer contract fails until the module and adapter hook exist; simulation-only tests remain green.

- [ ] **Step 3: Implement a bounded Three.js scene and object synchronization**
...
- [ ] **Step 4: Integrate asynchronous module loading without coupling simulation startup**
...
- [ ] **Step 5: Run Node regression tests and verify deterministic hashes**
...
- [ ] **Step 6: Commit the Three.js renderer task**
...
- [ ] **Step 1: Document provider configuration and demo behavior**
...
- [ ] **Step 2: Run the complete offline test set**
...
- [ ] **Step 3: Start the existing demo server and inspect desktop layout**
...
- [ ] **Step 4: Verify small-screen scaling and settings flow in browser**
...
- [ ] **Step 5: Inspect rendered game and simulate renderer fallback**
...
- [ ] **Step 6: Commit documentation and any final test adjustments**
